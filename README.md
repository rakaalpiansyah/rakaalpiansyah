...
I am an **Informatics Engineering** student at **UIN Sunan Gunung Djati Bandung**. I specialize in building impactful, user-centric Mobile and Web applications, with a strong focus on scalable architecture and clean code.

- 🔭 **Currently working on:** Scalable e-commerce backends and complex RESTful API integrations (Payment Gateways, Logistics).
- 🌱 **Currently learning:** Clean architecture patterns and advanced server deployments.
- 👯 **Looking to collaborate on:** Exciting open-source projects related to Web & Mobile development.
- 🤝 **Looking for help with:** Advanced cloud architecture and CI/CD pipelines.
- 💬 **Ask me about:** `Laravel`, `Flutter`, `API Integrations`, and `Database Design`.
- ⚡ **Fun fact:** I developed a waste management web platform that won a **National level competition!** 🏆
